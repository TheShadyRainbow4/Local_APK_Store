# Elite EasyScriptCompiler - v1.0.42.22
...
try {
    ...
    function Run-Compilation {
        ...
        $extractedVersion = Get-VersionFromFileName -FileName $compBase
        ...
        try {
            ...
            if ($scriptContent -match '([a-zA-Z0-9_\-\s]+\.ico)') {
                ...
                if (Test-Path $potentialPath) { 
                    ...
                    Write-EliteLog "Icon parsed from script code: $targetIcon" "INFO" "E105"
                }
            }
        } catch {}
        ...
        if (-not $targetIcon -and (Test-Path $sameNameIco)) {
            ...
            Write-EliteLog "Found matching filename icon: $targetIcon" "INFO" "E106"
        }
        ...
        try {
            ...
            if (Test-Path $outPath) {
                ...
                # Wait for any lingering compiler handles to release
