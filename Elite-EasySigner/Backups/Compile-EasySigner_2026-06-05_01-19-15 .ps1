...
# Wraps execution in a Legacy WinForms GUI with precision Aero Glass margins and GDI+ text fixing.
...
# Use ClientSize directly to avoid window border math discrepancies across OS versions
$mainForm.ClientSize = New-Object System.Drawing.Size(684, 461)
$mainForm.StartPosition = "CenterScreen"
$mainForm.FormBorderStyle = "FixedDialog"
$mainForm.MaximizeBox = $false

# The Opaque Shield Panel (Must be defined first so we can calculate margins from it)
...
# Apply Glass boundaries mathematically aligned to the Shield Panel
if ($GlassEnabled) {
    ...
    $mainForm.Add_Shown({
        try {
            if ([DWM]::DwmIsCompositionEnabled()) {
                ...
                # Dynamic precision: perfectly calculate the distance from form edges to panel edges
...
$glassCheckbox.Text = "Extend Frame to Client Area (Aero Glass)"
$glassCheckbox.Size = New-Object System.Drawing.Size(300, 20)
$glassCheckbox.Location = New-Object System.Drawing.Point(12, 395)
$glassCheckbox.Checked = $GlassEnabled
$glassCheckbox.BackColor = [System.Drawing.Color]::Transparent

# THE FIX: GDI+ Rendering handles transparent alpha-blending without the ClearType text corruption
$glassCheckbox.UseCompatibleTextRendering = $true
