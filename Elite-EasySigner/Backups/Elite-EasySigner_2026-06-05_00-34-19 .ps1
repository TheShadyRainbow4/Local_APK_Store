...
try {
    ...
    $form.Text = "Elite EasySigner - v1.0.47.0"
    ...
    $lblHeaderSub.Text = "v1.0.47.0 - EliteSoftware Certificate Signing Utility"
    ...
    Write-Log "Elite EasySigner UI Initialized as standard process." "info"
